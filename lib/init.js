...
function _initSetters() {
    require('http').globalAgent.maxSockets = 500; //TODO fulhakket
    require('https').globalAgent.maxSockets = 500; //TODO fulhakket
    ...
    app.set('pretty', _.isEqual(app.get('env'), 'development'));
...
function _initMiddleware() {
    ...
    app.use(function(req, res, next){
        ...
        res.locals.site = app.config.site; // used in various templating
    ...
    require('./authorization').initRankVerifier(app);
...
function _initSession() {
    var cookieSettings = {},
        ...
        mongoUri = 'mongodb://' +
            ...
            connectionConfig.sessionCollection,
    ...
    cookieSettings.maxAge = 60*60*1000; // 1 min
...
function _initRoutes() {
    ...
    require('./authorization').updatePageRanks(pageRanks);
